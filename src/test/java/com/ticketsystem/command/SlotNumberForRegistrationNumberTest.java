...
public class SlotNumberForRegistrationNumberTest {
    ...
    public void testRegistrationNumbersForCarsWithColour() {
        assertEquals(
                "class com.ticketsystem.command.SlotNumberForRegistrationNumber",
                this.slotNumberForRegistrationNumber.getClass().toString());
    }

    @Test
    public void testExecuteTicketServiceNotInitialized() {

        SlotNumberForRegistrationNumber slotNumberForRegistrationNumber = new SlotNumberForRegistrationNumber("KA-01-HH-1234");
        String message = "TicketService is not available";

        assertThat(slotNumberForRegistrationNumber.execute(), equalTo(message));
    ...
    public void testExecuteSuccess() {
        ...
        slotNumberForRegistrationNumber.setTicketService(ticketService);
        slotNumberForRegistrationNumber.setRegistrationNumber("KA-01-BB-0001");
